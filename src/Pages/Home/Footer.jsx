  ...
  return (
    <footer className="footer--container">
      <div className="footer--link--container">
        ...
        <div className="footer--social--icon">
          <ul>
            <li>
              <a
                href="https://github.com/joaolucassb"
            ...
            <li>
              <a
                href="https://twitter.com/joaolucassbzr"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
            ...
            <li>
              <a
                href="https://www.linkedin.com/in/joao-lucas-bezerra"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
      ...
      <div className="footer--content--container">
        <p className="footer--content">Feito com 💖 por João</p>
        <div className="footer--social--icon">
          <ul>
            <li>
              <Link
